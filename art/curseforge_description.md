...
- **Modpacks are allowed and encouraged** — any platform, no need to ask. Use the official files and credit *NeroAgriculture by Neroland* with links to this page and the [GitHub repository](https://github.com/Neroland/neroagriculture). Full terms: [LICENSE](https://github.com/Neroland/neroagriculture/blob/main/LICENSE).
...
- 🟢 **[Also on Modrinth](https://modrinth.com/mod/neroagriculture)**
