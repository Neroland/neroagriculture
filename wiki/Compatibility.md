...
| AE2 | Component-backed seed/fragment variants via generic item handlers | Dormant until AE2 ports to 26.1+ |
...
See also: [Material Catalog and Crop Storage](Material-Catalog-and-Crop-Storage.md), [Biofuel and Fragment
Blocks](Biofuel-and-Fragment-Blocks.md).
