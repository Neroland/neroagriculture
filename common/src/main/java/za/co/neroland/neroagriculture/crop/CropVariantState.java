...
public record CropVariantState(int formatVersion, Identifier material, EssenceFamily family, int harvestCount) {
    ...
    public static final Codec<CropVariantState> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            EssenceFamily.CODEC.fieldOf("family").forGetter(CropVariantState::family),
    ...
    public static CropVariantState fresh(Identifier material) { return fresh(material, EssenceFamily.ORBITAL); }
    public static CropVariantState fresh(Identifier material, EssenceFamily family) { return new CropVariantState(CURRENT_FORMAT, material, family, 0); }
